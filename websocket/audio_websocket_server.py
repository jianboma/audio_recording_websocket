"""
This script is inspired by websocket_server # (Author: Johan Hanssen Seferidis, Johan Hanssen Seferidis's script is unber License: MIT)
"""
...
class WebsocketServer(ThreadingMixIn, TCPServer, API):
    ...
    def _new_client_(self, handler):
        ...
        client = {
            ...
            'of': wave.open('./recorded_samples/recording_'+str(self.id_counter)+'.wav', 'wb')
        }
...
class WebSocketHandler(StreamRequestHandler):
    ...
    def read_next_message(self):
        ...
        # sampleWidth, numSamples = struct.unpack('<bi', self.read_bytes(5))
